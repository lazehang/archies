...
<section class="content">
    <div class="box container"><br>
        <a href="newproduct.php?fcat=newcollection" class="btn btn-primary">Add Product</a><br>
        <h2 class="well well-sm ">New Collection</h2>
        <div class="table-responsive">
            ...
            <tbody>
              <?php
                $query = mysqli_query($conn,"SELECT a.* FROM products a inner join categories b on a.category_id = b.id Where b.category = 'newcollection' ") or die(mysqli_error());
