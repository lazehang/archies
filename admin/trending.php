...
<section class="content">
    <div class="box container"><br>
        <a href="newproduct.php?fcat=trending" class="btn btn-primary">Add Product</a><br>
        ...
        <div class="table-responsive">
            ...
            <tbody>
              <?php
                $query = mysqli_query($conn,"SELECT a.* FROM products a inner join categories b on a.category_id = b.id Where b.category = 'trending' ") or die(mysqli_error());
