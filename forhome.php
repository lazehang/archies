...
<body>
		...
		<div class="head-banner container col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="banner-caption"><h1>FOR HOME</h1></div>
...
<?php
    ...
    if(isset($page))
  {
    ...
    if($page <=1 ){
      ...
      echo "<li class='page-item'><a class='page-link' href='forhome.php?page=$j'>< Prev</a></li>";
    }
    ...
    for($i=1; $i <= $totalPages; $i++)
    {
      if($i<>$page)
      {     
        echo "<li class='page-item'><a class='page-link' href='forhome.php?page=$i'>$i</a></li>";
      }
...

    {
      ...
      echo "<li class='page-item'><a class='page-link' href='forhome.php?page=$j'>Next</a></li>";
