...
<section class="product-inner-showcase ">
    <div class="container" style="width:100%;">
      <div class="row">
        ...
        $calc = $perpage * $page;
        $start = $calc - $perpage;
        $result = mysqli_query($conn, "SELECT a.* FROM products a inner join main_categories b on a.main_category_id = b.id Where b.category = 'for her'  Limit $start, $perpage");
...
<?php
    ...
    if(isset($page))
  {
    ...
    $result = mysqli_query($conn,"SELECT a.* FROM products a inner join main_categories b on a.main_category_id = b.id Where b.category = 'for her'");
    ...
    if($page <=1 ){
      ...
      echo "<li class='page-item'><a class='page-link' href='forher.php?page=$j'>< Prev</a></li>";
    }
    ...
    for($i=1; $i <= $totalPages; $i++)
    {
      if($i<>$page)
      {     
        echo "<li class='page-item'><a class='page-link' href='forher.php?page=$i'>$i</a></li>";
      }
...

    {
      ...
      echo "<li class='page-item'><a class='page-link' href='forher.php?page=$j'>Next</a></li>";
